...
const Register = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#b9e7e7]">
      <h1 className="text-teal text-[20px] mb-[20px]">Register</h1>
      <form  className="flex flex-col p-[50px] bg-[#fff] gap-[20px] w-[400px]">
        ...
        <input required className="p-[10px] border-b-[1px] border-b-gray" type="email" placeholder="email" />
        ...
        <span className="text-[12px] text-center">Don't have an account? <Link className="text-teal" to="/login">Login</Link></span>
      </form>
    </div>
  )
}
